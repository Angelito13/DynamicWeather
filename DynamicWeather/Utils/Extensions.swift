...
extension Color {
    ...
    static let tabBorder = Color("Tab Bar Border").opacity(0.5)
    static let forecastBackground = Color("Forecast Card Background")
    static let probability = Color("Probability Text")
}
